...
# from models.base import base as Net
...
class PredOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--test_dir', required=False, default='/home/lab/lda/Bi-SRNet-SECOND/data/SECOND1/pred1',
                            help='directory to test images')
        parser.add_argument('--pred_dir', required=False, default='/home/lab/lda/Bi-SRNet-SECOND/ablation/pred-base',
                            help='directory to output masks')
        # parser.add_argument('--chkpt_path', required=False, default=working_path+'/checkpoints/base+estca+bdaf3/SECOND_24e_mIoU73.37_Sek23.19_Fscd62.55_OA87.86.pth')
        # parser.add_argument('--chkpt_path', required=False, default=working_path+'/checkpoints/BiSRNet/SSCDl+SCLoss_48e_mIoU72.54_Sek21.61_Fscd61.04_OA87.31.pth')
        # parser.add_argument('--chkpt_path', required=False, default=working_path+'/checkpoints/TBFFNet/SSCDl+SCLoss_46e_mIoU72.76_Sek21.75_Fscd61.17_OA87.54.pth')
        # parser.add_argument('--chkpt_path', required=False, default=working_path+'/checkpoints/HRSCD3/SECOND_48e_mIoU63.95_Sek9.18_Fscd48.77_OA83.90.pth')
        # parser.add_argument('--chkpt_path', required=False, default=working_path+'/checkpoints/HRSCD4/SECOND_45e_mIoU69.94_Sek16.16_Fscd55.75_OA85.86.pth')
        # parser.add_argument('--chkpt_path', required=False, default=working_path+'/checkpoints/SCCDl/SECOND_15e_mIoU72.24_Sek21.28_Fscd61.02_OA87.03.pth')
        # ablation
        parser.add_argument('--chkpt_path', required=False,
                            default=working_path + '/checkpoints/base/SECOND_19e_mIoU72.40_Sek21.54_Fscd61.37_OA87.51.pth')
        # parser.add_argument('--chkpt_path', required=False, default=working_path + '/checkpoints/base+estca/SECOND_29e_mIoU73.17_Sek22.88_Fscd62.24_OA87.64.pth')
        # parser.add_argument('--chkpt_path', required=False,default=working_path + '/checkpoints/base+bdaf/SECOND_34e_mIoU73.12_Sek22.65_Fscd62.03_OA87.84.pth')
        # parser.add_argument('--chkpt_path', required=False, default=working_path + '/checkpoints/base+estca+bdaf3/SECOND_24e_mIoU73.37_Sek23.19_Fscd62.55_OA87.86.pth')
